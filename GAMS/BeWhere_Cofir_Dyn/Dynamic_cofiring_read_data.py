...
###
##
print('set-biomass-price...')    
create_parameter_file(file_destination+'parameter-biomass-price.txt',['Y','RM'],pd.DataFrame(np.vstack([[df_year.iloc[i,0], df_RM.iloc[j,0], df_biom_price.values[i,j]]
...
create_parameter_file(file_destination+'parameter-fix-OM-cost-cofiring.txt',['Tech'],pd.DataFrame(np.vstack([[df_cofir_technologies.iloc[i,0], df_fix_var_OM_cofir_cost.values[114,0]]
                                             for i in range(df_cofir_technologies.shape[0])])))
    
print('parameter-var-OM-cost-cofiring...')    
create_parameter_file(file_destination+'parameter-var-OM-cost-cofiring.txt',['Tech'],pd.DataFrame(np.vstack([[df_cofir_technologies.iloc[i,0], df_fix_var_OM_cofir_cost.values[115,0]]
                                             for i in range(df_cofir_technologies.shape[0])])))
...
create_parameter_file(file_destination+'parameter-transport-fix-cost.txt',['RM','T'],pd.DataFrame(np.vstack([[df_RM.iloc[i,0], df_transport_mode.iloc[j,0], df_fix_var_transport_cost.values[i,0]]
                                             for i in range(df_RM.shape[0])
                                             for j in range(df_transport_mode.shape[0])])))
    
print('parameter-transport-var-cost...')    
create_parameter_file(file_destination+'parameter-transport-var-cost.txt',['RM','T'],pd.DataFrame(np.vstack([[df_RM.iloc[i,0], df_transport_mode.iloc[j,0], df_fix_var_transport_cost.values[i,1]]
                                             for i in range(df_RM.shape[0])
                                             for j in range(df_transport_mode.shape[0])])))
...
create_parameter_file(file_destination+'parameter-price-carbon.txt',['Y'],pd.DataFrame(np.vstack([[df_year.iloc[yy,0], df_carbon_price.values[33,0]]
